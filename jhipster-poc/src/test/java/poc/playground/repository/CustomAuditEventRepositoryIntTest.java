package poc.playground.repository;

import poc.playground.PocApp;
import poc.playground.config.Constants;
import poc.playground.config.audit.AuditEventConverter;
import poc.playground.domain.PersistentAuditEvent;
...
import static poc.playground.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
